...
//perry add for Sierra 4G (compare with MTK's sierra.c) 2015/05/13
static const signed char mc73xx_non_serial_ifaces[]  = { 4, 5, 6, 8, 10, 11 };
static const struct sierra_iface_info mc73xx_interface_blacklist = {
	.infolen = ARRAY_SIZE( mc73xx_non_serial_ifaces ),
	.ifaceinfo = mc73xx_non_serial_ifaces,
};
//perry end
...
static const struct usb_device_id id_table [] = {
	...
	{ USB_DEVICE(0x1199, 0x68C0),
		.driver_info = (kernel_ulong_t)&mc73xx_interface_blacklist //perry modify for Sierra 4G (compare with MTK's sierra.c) 2015/05/13
	},		
