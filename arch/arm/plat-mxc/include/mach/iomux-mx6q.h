...
#define MX6Q_HIGH_DRV_TEST	(PAD_CTL_DSE_34ohm)

#define MX6Q_I2C_PULL_HIGH	(PAD_CTL_PUS_100K_UP| PAD_CTL_PUE |PAD_CTL_PKE | PAD_CTL_DSE_40ohm)    /******* to pull I2C high added by kevin  ********/

#define MX6Q_TEST		(PAD_CTL_PUS_100K_UP| PAD_CTL_PUE |PAD_CTL_PKE | PAD_CTL_DSE_40ohm) 


#define MX6Q_TEST_HIGH		( PAD_CTL_PUS_22K_UP| PAD_CTL_PUE |PAD_CTL_PKE) /******* to pull USB GPIO high added by kevin  ********/
