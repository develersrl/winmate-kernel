...
#include "board-FA30.h"
#include <linux/i2c/at24.h>
#include <mach/imx_rfkill.h>

#define SABRESD_BLON_3V_H	IMX_GPIO_NR(1, 2)
#define SABRESD_MICROPHONE_DET	IMX_GPIO_NR(1, 9)
#define SABRESD_PAD28		IMX_GPIO_NR(1, 10)
#define SABRESD_PAD25		IMX_GPIO_NR(1, 11)
#define SABRESD_PAD60		IMX_GPIO_NR(1, 12)
#define SABRESD_PAD61		IMX_GPIO_NR(1, 13)
#define SABRESD_PAD29		IMX_GPIO_NR(1, 14)
#define SABRESD_PAD59		IMX_GPIO_NR(1, 15)
#define SABRESD_PAD58		IMX_GPIO_NR(1, 16)

#define SABRESD_BUZZER_INTERNAL    IMX_GPIO_NR(1, 17)

#define SABRESD_FAN_EN		IMX_GPIO_NR(1, 18)
...
#define SABRESD_PAD67		IMX_GPIO_NR(2, 23)
#define SABRESD_PAD33		IMX_GPIO_NR(2, 24)
...
#define SABRESD_PAD32		IMX_GPIO_NR(3, 25)
#define SABRESD_TS_INT		IMX_GPIO_NR(3, 26)
#define SABRESD_PAD63		IMX_GPIO_NR(3, 27)
...
#define SABRESD_PAD27		IMX_GPIO_NR(5, 2)
#define SABRESD_PAD46		IMX_GPIO_NR(5, 18)
#define SABRESD_PAD51		IMX_GPIO_NR(5, 19)
#define SABRESD_PCIE_WAKE_B	IMX_GPIO_NR(5, 20)
#define SABRESD_PAD47		IMX_GPIO_NR(5, 21)

#define SABRESD_PAD52			IMX_GPIO_NR(5, 30)
#define SABRESD_PAD42			IMX_GPIO_NR(5, 31)

#define SABRESD_PAD5			IMX_GPIO_NR(6, 0)
#define SABRESD_PAD11			IMX_GPIO_NR(6, 1)
#define SABRESD_PAD10			IMX_GPIO_NR(6, 2)
#define SABRESD_PAD15			IMX_GPIO_NR(6, 3)
#define SABRESD_PAD7			IMX_GPIO_NR(6, 4)
#define SABRESD_PAD4			IMX_GPIO_NR(6, 5)
...
#define SABRESD_PAD24			IMX_GPIO_NR(6, 17)
#define SABRESD_PAD23			IMX_GPIO_NR(6, 18)
#define SABRESD_PAD64			IMX_GPIO_NR(6, 31)

#define SABRESD_PAD21			IMX_GPIO_NR(7, 0)
#define SABRESD_PAD22			IMX_GPIO_NR(7, 1)
...
static int mx6q_sabresd_fec_phy_init(struct phy_device *phydev)
{
	...
	i=0;
	//set the mac address for fa30 20150211 product
#ifdef CONFIG_MACH_FA30
              /*MAC_Address_For_eth0[0]='0';//48;//0
              MAC_Address_For_eth0[1]='0';//48;//0
	      MAC_Address_For_eth0[2]=':';//58//:
              MAC_Address_For_eth0[3]='0';//48;//0
              MAC_Address_For_eth0[4]='3';//51;//3
	      MAC_Address_For_eth0[5]=':';//58;//:
              MAC_Address_For_eth0[6]='E';//69;//E
              MAC_Address_For_eth0[7]='1';//49;//1
	      MAC_Address_For_eth0[8]=':';//58;//:
              MAC_Address_For_eth0[9]='9';//57;//9
              MAC_Address_For_eth0[10]='3';//51;//3
	      MAC_Address_For_eth0[11]=':';//58;//:
              MAC_Address_For_eth0[12]='8';//56;//8
              MAC_Address_For_eth0[13]='F';//70;//F
	      MAC_Address_For_eth0[14]=':';//58;//:
              MAC_Address_For_eth0[15]='B';//66;//B
              MAC_Address_For_eth0[16]='1';//49;//1 */
#endif
	while(i<17)
        {
...
static struct ipuv3_fb_platform_data sabresd_fb_data[] = {
	{ /*fb0*/
#ifdef CONFIG_MACH_FA33
	.disp_dev = "ldb",
	.interface_pix_fmt = IPU_PIX_FMT_RGB666,					  /*rudolph modify 24 to 666*/
	.mode_str = "LDB-XGA",
	.default_bpp = 24,
	.int_clk = false,
	.late_init = false,
...
#ifdef CONFIG_MACH_FA30
	.disp_dev = "ldb",
        //.interface_pix_fmt = IPU_PIX_FMT_RGB24,                                                  /****24 for winmate***/
...
static struct fsl_mxc_ldb_platform_data ldb_data = {
	...
	.disp_id = 1,
	.ext_ref = 1,
	.mode = LDB_SEP0,       //modified by kevin      original:LDB_SEP1  controlled lvds channel by ldb.c
	.sec_ipu_id = 0,
	.sec_disp_id = 0,
};
...
static struct gpio_keys_button new_sabresd_buttons[] = {
	GPIO_BUTTON(SABRESD_DIMMING_UP, KEY_VOLUMEUP, 1, "volume-up", 0, 1),
	GPIO_BUTTON(SABRESD_DIMMING_DN, KEY_VOLUMEDOWN, 1, "volume-down", 0, 1),
